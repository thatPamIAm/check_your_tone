    ...
    function(err, tone) {
      ...
      var postToSlack = {
        ...
        "attachments": [{
          ...
          "pretext": `${userInput}`,
          "author_name": "Tone Analyzer",
          "title": "For each emotion, a score of less than 0.5 indicates that the emotion is unlikely to be perceived in the content. Likewise, a score greater than 0.75 indicates high likelihood that the emotion will be perceived.",
          "mrkdwn_in": ["text"],
          "text":`*${slack[0].tone_name}* : ${Math.floor(scoreAnger * 100)}%
*${slack[1].tone_name}* : ${Math.floor(scoreDisgust * 100)}%
*${slack[2].tone_name}* : ${Math.floor(scoreFear * 100)}%
